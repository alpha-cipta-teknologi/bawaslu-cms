...
// ** Store & Actions
import { getDataKomunitas, getKomunitas } from '../store/action'
    ...
    <div className='invoice-list-table-header w-100 mr-1 ml-50 mt-2 mb-75'>
      <Row>
        ...
        >
          ...
          {ability.can('create', 'komunitas') &&
            <Link to='/komunitas/save' onClick={handleCreate}>
