...
// ** Store & Actions
import { getDataStatistikArtikelTema, getStatistikArtikelTema } from '../store/action'
...
const ClassList = () => {
  ...
  const [selectedTema, setSelectedTema] = useState({label: 'Tema'})
  ...
  }, [debouncedSearch, currentPage, rowsPerPage, selectedProvince, selectedRegency, selectedTema])
  ...
  const handleCreate = e => {
    dispatch(getStatistikArtikelTema(null))
  }
